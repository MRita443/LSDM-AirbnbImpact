...
ALTER TABLE public.Neighborhood ADD CONSTRAINT fk_neigh_borough FOREIGN KEY (borough_id) REFERENCES public.Borough (borough_id);

-- Hosts -> Neighborhood
ALTER TABLE public.Airbnb_Hosts ADD CONSTRAINT fk_host_neigh FOREIGN KEY (neighborhood_id) REFERENCES public.Neighborhood (neighborhood_id);

-- Listings -> Hosts, Borough, Neighborhood
ALTER TABLE public.Airbnb_Listings ADD CONSTRAINT fk_list_host FOREIGN KEY (host_id) REFERENCES public.Airbnb_Hosts (host_id);

ALTER TABLE public.Airbnb_Listings ADD CONSTRAINT fk_list_neigh FOREIGN KEY (neighborhood_id) REFERENCES public.Neighborhood (neighborhood_id);

-- Sales -> Borough, Neighborhood
ALTER TABLE public.NYC_Rolling_Sales ADD CONSTRAINT fk_sale_neigh FOREIGN KEY (neighborhood_id) REFERENCES public.Neighborhood (neighborhood_id);

-- Crime -> Borough, Neighborhood
ALTER TABLE public.NYPD_Complaints ADD CONSTRAINT fk_crime_neigh FOREIGN KEY (neighborhood_id) REFERENCES public.Neighborhood (neighborhood_id);